...
import sideImg from '../Images/Business1.jpg';
import bannerImg from '../Images/Business2.jpg';

const Business = () => {
	return (
		<Base title="Working With Business" bgImage={bannerImg} sidebarImage={sideImg}>
			<div>
