...
import sideImg from '../Images/Resources2.jpg';
import bannerImg from '../Images/Resources1.jpeg';

const Resources = () => {
	return (
		<Base title="Learning Resources" bgImage={bannerImg} sidebarImage={sideImg}>
